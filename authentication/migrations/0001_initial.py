# Generated by Django 5.0.1 on 2024-09-18 12:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(related_name='UsersRegistration', to='auth.group')),
                ('user_permissions', models.ManyToManyField(related_name='UsersRegistration_permissions', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
